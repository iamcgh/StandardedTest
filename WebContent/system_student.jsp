...
<%
	...
	//String genderStr = currentUser.getName().equals("男")? "先生":"女士";
%>
</head>
...
<body>
	<div class="page-header">
		<h1>
			欢迎使用标准化考试系统 <small><%=student.getName() + "同学"%></small>
		</h1>
	</div>
	<div>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav" id="choice">
						...
						<!-- <li><a href="upload.html" target="pageContent">上传试题</a></li> -->
						<li><a href="student_infos.jsp" target="pageContent">个人信息</a></li>
						<li><a href="score.jsp" target="pageContent">成绩管理</a></li>
					</ul>

					<ul class="nav navbar-nav navbar-right">
						<li id="log_out"><a href="${APP_PATH }/LogOutServlet">退出登录</a></li>
